-- Seed: Supabase schema + tables for copilotkit-forms
--
-- This file is intended to be applied to a *fresh* Supabase Postgres database.
-- It is a concatenation of:
--   1) database-schema/prod.sql
--   2) database-schema/schema-v1.0.0-to-1.2.0.sql
--
-- Notes:
-- - These upstream files contain CREATE/ALTER statements that may not be safe to re-run on an existing DB.
-- - Apply once during initial setup.


-- ===== BEGIN database-schema/prod.sql =====
...
-- ===== END database-schema/prod.sql =====



-- ===== BEGIN database-schema/schema-v1.0.0-to-1.2.0.sql =====
...
-- ===== END database-schema/schema-v1.0.0-to-1.2.0.sql =====
